...
public class Token {
    ...
    public void test(@Optional("ZH33L2Z6KL") String runOn) {
        try {
            ...
            api.enterTextRID("tokenNameEdit", "hi");
            api.enterTextRID("tokenSerialEdit", "123");
